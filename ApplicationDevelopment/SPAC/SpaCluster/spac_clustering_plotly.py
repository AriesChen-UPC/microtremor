...
@file: spac_clustering_plotly.py
"""
...
def spac_clustering_plotly(folder_path, fs, freq, spac, names, freq_theory_spac, theory_spac, min_freq, max_freq,
                           clustering, n_clusters):
    """
    Plotly plot the spac clustering result.
    :param folder_path: the path of the folder to save the plot.
    :param fs: the number of the spac file.
    :param freq: the frequency of the signal.
    :param spac: the spac result.
    :param names: the name of the signal.
    :param freq_theory_spac: the frequency of the theoretical spac result.
    :param theory_spac: the theoretical spac result.
    :param min_freq: the minimum frequency of the signal.
    :param max_freq: the maximum frequency of the signal.
    ...
    if n_clusters == 1:
        ...
        fig.add_trace(go.Scatter(x=freq_theory_spac['freq'], y=theory_spac['autoCorrRatio'], name='theory SPAC',
    ...
    fig.update_layout(title='SPAC cluster')
    fig.update_layout(
    ...
    default_html_name = folder_path + '/' + 'spaCluster.html'
