...
class Fetch:
    ...
    def sendRequest(self, api, workerName, params):
        ...
        apimap = {'class': api, 'method': workerName}
    ...
    def getObject(self, api, workerName, params):
        ...
        if data_dic['type'] == 'object':
            ...
            raise (ServerResponseException(
                "type check error, 'object' expected but " + data_dic["type"] + " provided," + retstring))
    ...
    def getArray(self, api, workerName, params):
        ...
        if data_dic['type'] == 'array':
            ...
            raise (ServerResponseException(
                "type check error, 'array' expected but " + data_dic["type"] + " provided," + retstring))
    ...
    def getInt(self, api, workerName, params):
        ...
        if data_dic['type'] == 'int':
            ...
            raise (ServerResponseException(
                "type check error, 'int' expected but " + data_dic["type"] + " provided," + retstring))
    ...
    def getDouble(self, api, workerName, params):
        ...
        if data_dic['type'] == 'float':
            ...
            raise (ServerResponseException(
                "type check error, 'float' expected but " + data_dic["type"] + " provided," + retstring))
    ...
    def getBool(self, api, workerName, params):
        ...
        if data_dic['type'] == 'bool':
            ...
            raise (ServerResponseException(
                "type check error, 'bool' expected but " + data_dic["type"] + " provided," + retstring))
    ...
    def getString(self, api, workerName, params):
        ...
        if data_dic['type'] == 'string':
            ...
            raise (ServerResponseException(
                "type check error, 'string' expected but " + data_dic["type"] + " provided," + retstring))
