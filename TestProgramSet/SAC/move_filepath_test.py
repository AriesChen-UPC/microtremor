...
#%% select the original sac data folder

print('\033[0;31mPlease select the original sac data folder：\033[0m')
root = tk.Tk()
root.withdraw()
...
#%% select the destination folder, make group folders and subfolders
...
sac_destination_folder_path = sac_destination_folder_path + '/' + 'DTCC/' + 'SAC'  # todo: the 'DTCC/SAC' is not good
