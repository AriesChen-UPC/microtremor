...
if is_A_exist == 0:
    ...
    print('\033[0;32mThe file path of A is complete!\033[0m')
if is_B_exist == 0:
    ...
    print('\033[0;32mThe file path of B is complete!\033[0m')
if is_C_exist == 0:
    ...
    print('\033[0;32mThe file path of C is complete!\033[0m')
if is_D_exist == 0:
    ...
    print('\033[0;32mThe file path of D is complete!\033[0m')
if is_E_exist == 0:
    ...
    print('\033[0;32mThe file path of E is complete!\033[0m')
print('------------------------------')
