...
@time:19/06/2021
@update:06/11/2021
@file: HV_clustering_samefolder_adjust.py
...
freq = np.geomspace(0.1, 100.1, 400)  # todo: read freq automatically. Notice: the data dimension maybe not the same
...
fig.update_yaxes(range=[0, 6.0], tick0=0.00, dtick=0.5)
