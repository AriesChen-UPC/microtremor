...
fig = make_subplots(rows=3, cols=3,
                    specs=[[{"rowspan": 3, "colspan": 1}, {}, {}],
                           ...
                           [None, {}, {}]],
                    print_grid=True,
                    subplot_titles=('HVSR', 'HVSR_1', 'HVSR_2', 'HVSR_3', 'HVSR_4', 'HVSR_5', 'HVSR_6'))
...
fig.update_layout(title=Folderpath.split("/")[-2])  # for cloud platform
# fig.update_layout(title=Folderpath.split("/")[-1])  # for manual platform
fig.update_xaxes(title_text="Frequency (Hz)")
fig.update_yaxes(title_text="Amplitude")
htmlFileName = Folderpath.split("/")[-2] + '_HVSR' + '.html'  # for cloud platform
# htmlFileName = Folderpath.split("/")[-1] + '_HVSR' + '.html'  # for manual platform
